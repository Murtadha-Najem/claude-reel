...
PANNS_DIR = Path.home() / "panns_data"      # panns-inference's own default; setup_models.py fills it
...
SHAZAM_LIMIT = None        # a batch runner may set a shared semaphore: Shazam's rate limit is undocumented, so one at a time
_TAGGER = {}
